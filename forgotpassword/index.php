...
//header('Location: http://studentbook.itmind4u.com/user  ');   //redirect to the approprite page after sending the request. // login page location ( user )
  ...
  <form id="form" method="post" action="#">
    ...
    <h2>Enter your email to reset your password. You may need to unblock studentbook2013@studentbook.com or check your
      spam folder.</h2>
...
<?php } else {
  ...
  if (isset($_REQUEST['key'])) {
    ...
    if ($_REQUEST['key'] == $get_code) {
      ...
      $sql = mysql_query("SELECT id,email,username,reset,expire FROM student WHERE reset='$get_original_data'") or die (mysql_error());
