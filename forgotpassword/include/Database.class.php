...
class Database {
  ...
  var $database = "liveedit"; //database name
  var $pre = "user"; //table prefix
...
function oops($msg = '') {
    ...
    <table align="center" border="1" cellspacing="0" style="background:white;color:black;width:80%;">
      ...
      <?php if (!empty($this->error)) echo '<tr><td align="right" valign="top" nowrap>mysqli Error:</td><td>' . $this->error . '</td></tr>'; ?>
      <tr>
