...
?>
		...
		<div id="formContainer">
			...
			<form id="login" method="post" action="login.php">
				...
				<a href="#" id="flipToRegister" class="flipLink"></a>
        ...
        <a href="forgotpassword" class="forgotpassword"> Forgot Password ?</a>
			...
			<form id="register" method="post" action="register.php">
				...
				<a href="#" id="flipToLogin" class="flipLink"></a>
				...
				<input type="password" name="regpassword" id="registerEmail" placeholder="Password" />
